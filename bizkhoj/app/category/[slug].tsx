...
import { getBusinessList } from "../utils/data";
...
export default function CategoryScreen() {
  ...
  // Get all businesses and filter by location if needed
  const allBusinesses = getBusinessList();
  const businesses = selectedLocation
    ? allBusinesses.filter((b: Business) =>
        b.address.includes(selectedLocation)
      )
    : allBusinesses;
  ...
  const renderBusinessCard = ({ item }: { item: Business }) => {
    const openNow = isBusinessOpenNow(item.openTime, item.closeTime);
    return (
        ...
        >
          ...
          <View style={styles.statusRow}>
            <View
              style={[
                styles.statusBadge,
                openNow ? styles.openBadge : styles.closedBadge,
              ]}
            >
              <View
                style={[
                  styles.statusDot,
                  openNow ? styles.openDot : styles.closedDot,
                ]}
              />
              <Text
                style={[
                  styles.statusText,
                  openNow ? styles.openText : styles.closedText,
                ]}
              >
                {openNow ? "Open" : "Closed"}
              </Text>
