...
export default function Index() {
  ...
  const handleSearchFocus = () => {
    ...
    categoriesOpacity.value = withTiming(0, {
      duration: 250,
      easing: Easing.out(Easing.ease),
    });
    categoriesTranslateY.value = withTiming(20, {
      duration: 250,
      easing: Easing.out(Easing.ease),
    });
  };
  ...
  const handleSearchBlur = () => {
    if (!searchText) {
      ...
      categoriesOpacity.value = withTiming(1, {
        duration: 250,
        easing: Easing.out(Easing.ease),
      });
      categoriesTranslateY.value = withTiming(0, {
        duration: 250,
        easing: Easing.out(Easing.ease),
      });
    }
